...
> Status dokumen: ini adalah dokumen arsip yang awalnya ditulis untuk snapshot `2026-03-27`. Setelah itu, definisi **Phase 3** di repo ini direvisi. Kontrak resmi yang sekarang berlaku ada di [GUIDE.md](../../GUIDE.md), [outputs/phase1/locked_setup.yaml](../phase1/locked_setup.yaml), dan artefak baru di [outputs/phase3/](../phase3/). Jika ada bagian di bawah yang masih menyebut run lama `p3_final_yolo11m_640_s42_e60p15m60` atau pola `train+val`, anggap itu sebagai konteks historis, bukan kontrak aktif.
...
- [outputs/phase3/final_metrics.csv](../phase3/final_metrics.csv)
- [outputs/phase3/per_class_metrics.csv](../phase3/per_class_metrics.csv)
- [outputs/phase3/confusion_matrix.csv](../phase3/confusion_matrix.csv)
...
- [outputs/phase3/detail/](../phase3/detail/)
- [outputs/phase3/figures/](../phase3/figures/)

## 6. Setup resmi yang sekarang harus dianggap aktif
...
- [outputs/phase1/locked_setup.yaml](../phase1/locked_setup.yaml)
- [GUIDE.md](../../GUIDE.md)
- [outputs/phase3/final_data.yaml](../phase3/final_data.yaml)
...
### Bentuk command Phase 3 yang sekarang dipakai

```bash
python scripts/e0_master_autonomous.py --from-phase phase3
```

Untuk unit run one-stage, bentuk command dasarnya sekarang menyerupai:
...
6. [outputs/phase3/final_metrics.csv](../phase3/final_metrics.csv)
7. [outputs/phase3/detail/](../phase3/detail/)
